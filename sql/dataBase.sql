...
create table users_recipes_avis
(
    user_id   int not null,
    recipe_id int null,
    avi_id    int null,
    constraint users_recipes_avis_pk
        unique (user_id, recipe_id, avi_id),
    constraint users_recipes_avis_id_fk
        foreign key (avi_id) references avis (id)
            on update cascade on delete cascade,
    constraint users_recipes_recipes_id_fk
        foreign key (recipe_id) references recipes (id)
            on update cascade on delete cascade,
